...
JNIEXPORT jint JNICALL Java_com_khopan_win32_Win32_InitiateSystemShutdown(JNIEnv* environment, jclass win32, jstring lpMachineName, jstring lpMessage, jlong dwTimeout, jboolean bForceAppsClosed, jboolean bRebootAfterShutdown) {
	...
	jint result = InitiateSystemShutdownW(const_cast<LPWSTR>(machineName), const_cast<LPWSTR>(message), static_cast<DWORD>(dwTimeout), bForceAppsClosed, bRebootAfterShutdown);
